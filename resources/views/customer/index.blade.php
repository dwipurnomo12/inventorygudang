...
<div class="section-header">
    <h1>Data Customer</h1>
    <div class="ml-auto">
        <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_customer"><i class="fa fa-plus"></i> Customer</a>
    </div>
</div>
...
<script>
    ...
    $('#store').click(function(e){
        ...
        $.ajax({
            ...
            error:function(error){
                if(error.responseJSON && error.responseJSON.customer && error.responseJSON.customer[0]){
