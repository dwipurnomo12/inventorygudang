...
<div class="section-header">
    <h1>Data Supplier</h1>
    <div class="ml-auto">
        <a href="javascript:void(0)" class="btn btn-primary" id="button_tambah_supplier"><i class="fa fa-plus"></i> Supplier</a>
    </div>
</div>
...
<script>
    ...
    $('#store').click(function(e){
        ...
        $.ajax({
            ...
            error:function(error){
                if(error.responseJSON && error.responseJSON.supplier && error.responseJSON.supplier[0]){
